...
url = "https://finance.yahoo.com/quote/DX-Y.NYB/history/?period1=978307200&period2=1731110400"
driver.get(url)
...
csv_file_path = os.path.join(desktop_path, 'usd_index_prices.csv')  # CSV dosya yolu
